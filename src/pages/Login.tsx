...
import { login } from "../store/redux/authSlice.tsx";
      ...
      <div className="login__box">
        <div className="login__container">
          ...
          {error && (
            <Alert
              message={
                <span className="login__form-alert">
                  <svg
                    height="24"
                    width="24"
                    data-encore-id="icon"
          ...
          <hr role="presentation" className="login__line"></hr>
          ...
          >
            <Form.Item
              className="login__form-item-group"
              name="email"
              rules={[
                {
                  required: true,
            ...
            >
              <div>
                <Lable text="Email" id="login-email" />
                <InputField
                  id="login-email"
                  placeholder="Email"
            ...
            >
              <div>
                <Lable text="Password" id="login-password" />
                <InputField
                  id="login-password"
          ...
          <Text className="login__signup-text">
